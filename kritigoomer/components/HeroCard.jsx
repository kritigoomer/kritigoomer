export default function HeroCard() {
    ...
    return(
       <div className="mt-20 flex gap-4 justify-center h-59 p-4 items-center rounded-2xl hover:bg-white/5">
            <div className="flex w-54 h-full rounded-xl border-1 border-violet-300">
            ...
            <div className="flex flex-col h-full justify-between">
                <div className="flex flex-col justify-center">
                    <text className="font-heading text-6xl">hi, i am</text>
                    <text className="font-heading text-6xl">Kriti Goomer</text>
                </div>
